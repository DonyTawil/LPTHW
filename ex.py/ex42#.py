##pseudo code of what I am going to do
## first things first
## I believe I have to create class map that contains all the functions of the map
## Engine only contains play and action??
#I have no idea how to do this
#I think i'm getting smthg
##might look like this
#the_map=map()
#the_game=engine()
#while(True):
#    the_game.the_map.smthing_in_gettmap
...
class engine(object):
    ...
    def play(self):
        ...
        while True:
            ...
            next = a.(dic1[next])() 
b=engine("central_corridor")
b.play()        
#a=Map()
#b=engine(a.central_corridor())                     
